...
require_once '../class/blog.php';
 $blog = new blog();
$query_result = $blog->Edit_Blog_Info($blog_id);
$blog_info =mysqli_fetch_assoc($query_result);

if (isset($_POST['btn']))
{
    $blog->Upadte_Blog_Info($_POST);
}
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="hidden" name="blog_id" value="<?php echo $blog_info['blog_id'];?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" name="blog_description" class="form-control"><?php echo $blog_info['blog_description'];?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
